...
parser.add_argument("--dataset_name", type=str, default="gandata", help="name of the dataset")
...
dataloader = DataLoader(
    CelebADataset(
        "../%s" % opt.dataset_name, transforms_=train_transforms, mode="train", attributes=opt.selected_attrs
    ),
...
val_dataloader = DataLoader(
    CelebADataset(
        "../%s" % opt.dataset_name, transforms_=val_transforms, mode="val", attributes=opt.selected_attrs
    ),
    batch_size=10,
    shuffle=True,
    num_workers=0,
